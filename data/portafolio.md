...
### 1. MVP de Validacion Inteligente de Documentos con IA (UTEL) — PUBLICO
...
### 2. Implementacion ERP Cross-Country (Fajas Forma Tu Cuerpo)
...
### 3. Automatizaciones CRM (Onest Vision) — Cliente real
...
### 4. Hackathon EmprendIA LATAM - 1er Lugar
...
### 5. Agentes IA de Soporte de Ventas (Lambda AI) — Proyecto propio
...
### 6. QA Lead - Proyecto Mayor de BVC
